...
import minhlb.utilities.ReCaptcha;
...
public class LoginController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            isRecaptchaValid = ReCaptcha.isValid(gRecaptchaResponse);
            if (isRecaptchaValid) {
                ...
                if (user != null && user.isIsActive()) {
                    ...
                    System.out.println("isAdmin= " + user.isIsAdmin());
                    url = INDEX_PAGE;
                } else {
                    request.setAttribute("LOGIN_ERROR", "UserId/Password is invalid!");
                    url = LOGIN_PAGE;
                }
            } else {
                url = LOGIN_PAGE;
